...
loneSum(3, 3, 3) → 0
*/
// BT - This is messy, but functional. Will need to figure out how to shorten algorithms 
like this.
...
and returns that value fixed for the teen rule. In this way, you avoid repeating the teen 
...
*/
// BT - LOL @ this code. I found a stackoverflow recommendation for how to calculate 
the middle via math.min.
// Once again, LOL.
