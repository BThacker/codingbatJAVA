...
char of B, the second char of A, the second char of B, and so on. Any leftover chars go 
...
/*REPEATSEPERATOR
Given two strings, word and a separator, return a big string made of count occurences of 
...
that prefix string appear somewhere else in the string? Assume that the string is not empty 
...
that the number of chars to the left and right of the "xyz" must differ by at most one. 
...
*/
// This was a really weird problem. I keep initializing to 0.
