...
"b" return "Buzz". If both the "f" and "b" conditions are true, return "FizzBuzz". In all 
other cases, return the string unchanged. (See also: FizzBuzz Code) 
...
Otherwise so long as both b and c are different from a, the result is 1. Otherwise the 
result is 0. 
